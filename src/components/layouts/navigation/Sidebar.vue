      ...
      <ul class="nav metismenu" id="side-menu">
        ...
        <li>
          ...
          <ul class="nav nav-second-level collapse">
            <li>
              <router-link to="/dashboard">Dashboard Links</router-link>
            </li>
          </ul>
        </li>
        <li>
        ...
        <li>
          <router-link to="/home/" class="disabled">
          ...
          <ul class="nav nav-second-level collapse">
            <li>
              <router-link to="/home">Links</router-link>
            </li>
          </ul>
        </li>
        <li>
          <router-link to="/home/notices" class="disabled">
            <i class="fa fa-envelope"></i>
            <span class="nav-label">Notices</span>
            <span class="label label-warning pull-right">Counter</span>
          </router-link>
          <ul class="nav nav-second-level collapse">
            <li>
              <router-link to="/home/notices/">Links</router-link>
            </li>
          </ul>
        </li>
        <li>
        ...
        <li class="active">
          <a href="#">
            ...
            <span class="nav-label">SocialBoard</span>
            <span class="fa arrow"></span>
          </a>
